...
.pull-left[
####Peter Horton
![teacher](./RSM_files/images/teacher.png)]
.pull-right[
####Warning
**Alphabet Soup**
...
- DCFS uses **SDM** tools for **starting cases**, **removing children**, **reunifying families**, and **offering services.** ]
  <img src="https://2.bp.blogspot.com/-kPJODEZC43o/WtNnaZU8ucI/AAAAAAAAFCc/9LqktoPUqpsN-sDv3PNmkTFTJ6CQLT9qwCLcBGAs/w1200-h630-p-k-no-nu/bigstock-Female-counselor-writing-down-41875084-700x467.jpg" width="40%" height="auto" style="position: absolute; bottom: 0; left: 31%;">
---
Name: SDM_images
class:inverse, center
  .pull-left[![SDM1](./RSM_files/images/SDM1.png)]
  .pull-right[![SDM2](./RSM_files/images/SDM2.png)]
---
name: SDM_point
  .pagenote[*Background*/ **History of Predictive Analytics in LA DCFS**]
  .left-column[
...
- We should keep that in mind when listening to claims about how a new, more high tech predictive algorithm will help transform the system.]
  <img src="https://m.media-amazon.com/images/M/MV5BYjdhMzIzYTAtMjEyYi00ZGJmLTkyZTgtOWU4ZDU0Y2U2ZDc5XkEyXkFqcGdeQXVyOTc5MDI5NjE@._V1_.jpg" width="40%" height="auto" style="position: absolute; bottom: 0; left: 31%;">
---
name:AURA
  .pagenote[*Background*/ **History of Predictive Analytics in LA DCFS**]
  .left-column[
...
- A tool being created right **now**. The pilot was trained on historical data. It was then tested on real cases in fall 2021.]
  <img src=./RSM_files/images/risk_flag.png width="40%" height="auto" style="  border: 5px solid #555; position: absolute; bottom: 0; left: 31%;">
---
...
class: inverse, center
  ## Overview of the RSM
  ![modelplacement](./RSM_files/images/model_place.png)
---
name: funding_development
  .pagenote[*Funding & Development* / **Who built it, and who's paying?**]
  .pull-left[
  ###Funders
  ![contract](./RSM_files/images/contract.png)
  ![funders](./RSM_files/images/funders.png)]
  .pull-right[
  ###Developers
  ![team](./RSM_files/images/team.png)]
---
name: data1
  .pagenote[*Sources of Data* / **What does the tool see?** ]
  ###Claims to Use Only DCFS Data
  ![coded](./RSM_files/images/coded.png)
---
name: data2
  .pagenote[*Sources of Data* / **What does the tool see?** ]
...
class: inverse, center
  ...
  ![complex_charts](./RSM_files/images/complex_charts.png)
  ---
name: overview3
class: inverse, center
  ### What is complex-risk?
  ![complexity](./RSM_files/images/complexity.png)
---
name: results1
...
<img src="./RSM_files/images/complexity.png" width="60%" height="auto" style="position: absolute; bottom: 0; left: 31%;">
---
name: results2
  .pagenote[*Methodology* / **How does the tool work?**]
  .left-column[
